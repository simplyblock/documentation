...
source: "https://docs.simplyblock.io/latest/architecture/concepts/nvme-namespaces-and-subsystems/"
---
...
sbctl volume add lvol01 100G pool01 --max-namespace-per-subsys 10
```
...
sbctl volume add lvol02 100G pool01 --namespace <UUID>
```
