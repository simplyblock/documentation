...
source: "https://docs.simplyblock.io/latest/architecture/concepts/nvmf-security/"
---

# NVMe over Fabrics Security
...
sbctl storage-pool add <POOL_NAME> <CLUSTER_ID> --dhchap
```
...
- **Add a host:** `sbctl storage-pool add-host <POOL_ID> <HOST_NQN>` (keys are auto-generated based on the pool's
  security options).
