...
source: "https://docs.simplyblock.io/latest/non-kubernetes/usage/snapshotting/"
---

# Snapshotting a Logical Volume

Snapshots in simplyblock provide point-in-time copies of logical Volumes (LVs), allowing for backup, recovery, or
cloning operations without impacting the active workload. Snapshots can be created using the `sbctl`
...
- [Logical Volume Conditions](../operations/monitoring/lvol-conditions.md)
- [Alerting](../operations/monitoring/alerts.md)
