...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/security/authentication-encryption/"
---

# Host Authentication and Encryption
...
sbctl storage-pool add <POOL_ID> --dhchap
```
...
# Add an allowed host
sbctl storage-pool add-host <POOL_ID> <HOST_NQN>

# Remove an allowed host
sbctl storage-pool remove-host <POOL_ID> <HOST_NQN>
```
