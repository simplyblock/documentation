...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/storage-nodes/find-secondary-node/"
---
...
- Ensure `sbctl` is configured and can access the control plane.
