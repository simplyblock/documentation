...
source: "https://docs.simplyblock.io/latest/non-kubernetes/proxmox/"
---
...
| CLUSTER_ID                 | The simplyblock storage cluster id. The cluster id can be found using [`sbctl cluster list`](../../reference/cli/cluster.md).                   |
| CLUSTER_SECRET             | The simplyblock storage cluster secret. The cluster secret can be retrieved using [`sbctl cluster get-secret`](../../reference/cli/cluster.md). |
