...
source: "https://docs.simplyblock.io/latest/release-notes/25-3-pre/"
---
...
command affects a deployment, reach out to simplyblock support.

Most changes are backward-compatible, however, some are not. Following is a list of all changes.
