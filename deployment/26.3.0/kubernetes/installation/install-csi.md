...
source: "https://docs.simplyblock.io/latest/kubernetes/installation/install-csi/"
---

# Install Simplyblock CSI (only)
...
Credentials are available via `sbctl cluster get-secret` from any of the control plane nodes. For further
...
sbctl storage-pool add <POOL_NAME> <CLUSTER_UUID>
```
...
sbctl storage-pool add <POOL_NAME> <CLUSTER_UUID> --sec-options=sec-options.json
```
...
[demo@demo ~]# sbctl storage-pool add test 4502977c-ae2d-4046-a8c5-ccc7fa78eb9a
