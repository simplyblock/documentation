...
source: "https://docs.simplyblock.io/latest/non-kubernetes/usage/encrypting/"
---
...
the `sbctl` command line interface, and encrypted volumes are handled transparently during regular operation.
