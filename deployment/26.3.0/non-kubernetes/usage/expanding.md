...
source: "https://docs.simplyblock.io/latest/non-kubernetes/usage/expanding/"
---
...
workloads have sufficient storage as demand grows. The `sbctl` command line interface is used to expand the size of an
