...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/monitoring/io-stats/"
---

# Accessing I/O Stats (sbctl)

Simplyblock's `sbctl` tool provides the option to retrieve some extensive I/O statistics. Those
