...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/scaling/expanding-storage-pool/"
---
...
sbctl storage-pool list --cluster-id=<CLUSTER_ID>
```

```bash title="Inspect current pool settings"
sbctl storage-pool get <POOL_ID>
```

## Perform the Expansion

To expand a storage pool, use the `sbctl` command line interface:
...
- [Accessing I/O Stats (sbctl)](../monitoring/io-stats.md)
