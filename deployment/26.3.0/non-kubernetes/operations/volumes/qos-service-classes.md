...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/volumes/qos-service-classes/"
---
...
sbctl qos add db-ultra  10000
sbctl qos add db-std    5000
sbctl qos add test-load 5000
sbctl qos list
sbctl qos delete test-load
```
