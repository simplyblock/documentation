...
source: "https://docs.simplyblock.io/latest/non-kubernetes/operations/storage-nodes/"
---

# Storage Nodes

A storage node is operated with the `sbctl storage-node` commands. Most of what a node needs is automatic: an
