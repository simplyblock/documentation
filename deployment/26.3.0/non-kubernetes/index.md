...
source: "https://docs.simplyblock.io/latest/non-kubernetes/"
---
...
helpful, but the entire cluster is managed through the `sbctl` command-line interface or the management API.
...
- [CLI / Command-line interface](../reference/cli/index.md): complete `sbctl` command reference.
